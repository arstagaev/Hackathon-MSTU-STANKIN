...
# для родной камеры ./mjpg_streamer -o "./output_http.so -w ./www" -i "./input_raspicam.so -x 640 -y 480 -fps 10 -ex auto -awb auto -vs -ISO 100"
# для usb камеры внизу 
#сервер 
#./mjpg_streamer -o "./output_http.so -w ./www" -i "./input_uvc.so -r 1280x720 -softfps -u"
./mjpg_streamer -o "./output_http.so -w ./www" -i "./input_uvc.so -r 1280x720 -softfps 25 -u -q 100 -rot 180 -pl 50hz"
#просто в файл но я это не доделал
#./mjpg_streamer -o "output_file.so -f ../site/stream.jpg" -i "./input_uvc.so -r 640x480 -fps 10 -u"
